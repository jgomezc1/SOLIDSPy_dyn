...
#
    return
#
# Parametros del pulso de Ricker
#
nt = 1024
Tt = 4.0
tc = 0.5
...
FS = 1.0
#
# Calcula el pulso y lo grafica
#
Rick , time = ricker(nt , Tt , tc, fc)
grafsignalG(Rick , Tt/nt , 0)
#
# Calcula el espectro de Fourier del pulso (Transformada directa)
# y lo grafica
#
x , Samag , A , nfs = Ftrans(Rick , nt , Tt/nt , FS)
grafFourier(Samag , x , nfs , 1)
#
# Calcula la transformada inversa del espectro
# y lo grafica comprobando que se obtienen nuevamente el pulso.
#
ZZ = np.fft.ifft(A)
ZZ = np.real(ZZ)
grafsignalG(ZZ , Tt/nt , 2)
#
# Calcula nuevamente el espectro de Fourier del pulso
# para comprobar que no lo deterioro en la trasnformacion
# y lo grafica
#
x , Samag , A , nfs = Ftrans(ZZ , nt , Tt/nt , FS)
grafFourier(Samag , x , nfs , 3)
#
